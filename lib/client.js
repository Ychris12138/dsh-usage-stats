...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// dsh 0.1.7 renamed the primitives icon set from size-suffixed names
		// (`…Outline16` / `…Outline14`) to stroke-weight variants
		// (`…OutlineRegular` / `…OutlineMedium`; both still accept `size`).
		...
		const IconData = primitives.IconDataOutlineRegular ?? primitives.IconDataOutline16;
		const IconRefresh = primitives.IconRefreshOutlineRegular ?? primitives.IconRefreshOutline14;
		const IconClose = primitives.IconCloseOutlineRegular ?? primitives.IconCloseOutline16;
		const IconChevronLeft = primitives.IconChevronLeftOutlineRegular ?? primitives.IconChevronLeftOutline14;
		const IconChevronRight = primitives.IconChevronRightOutlineRegular ?? primitives.IconChevronRightOutline14;
				...
				children: [
					...
					react_jsx_runtime.jsx("div", {
						...
						children: react_jsx_runtime.jsxs("button", {
							...
							children: [
								react_jsx_runtime.jsx(IconData, { size: wide ? 14 : 18 }),
