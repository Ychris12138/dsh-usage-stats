...
const CANONICAL_ROUTES = Object.freeze({
	...
	orcarouter: { providerFamily: "orcarouter", accountAdapter: null, pricingFamily: "unknown", balanceScheme: null },
...
function hostRule(hostname) {
	...
	if (hostname === "api.orcarouter.ai") return { providerFamily: "orcarouter", accountAdapter: null, pricingFamily: "unknown" };
