...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function quotaPercentDisplay(providerId, usedPercent) {
			if (providerId !== "opencode-go") return usedPercent.toFixed(usedPercent % 1 === 0 ? 0 : 1);
			const rounded = Math.round((usedPercent + Number.EPSILON) * 10) / 10;
								...
								children: [
									react_jsx_runtime.jsxs("div", {
										...
										children: [
											...
											react_jsx_runtime.jsx("span", { className: S.quotaValue, children: translate("subscription.used", { value: quotaPercentDisplay(provider.id, used) }) })
										]
									}),
									react_jsx_runtime.jsx("div", {
